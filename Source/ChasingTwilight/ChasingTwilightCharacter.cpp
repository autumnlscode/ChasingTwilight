...
void AChasingTwilightCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &AChasingTwilightCharacter::Look);
	...
	{
		UE_LOG(LogChasingTwilight, Error, TEXT("'%s' Failed to find an Enhanced Input component! This template is built to use the Enhanced Input system. If you intend to use the legacy system, then you will need to update this C++ file."), *GetNameSafe(this));
	}
}
...
void AChasingTwilightCharacter::DoMove(float Right, float Forward)
{
...
void AChasingTwilightCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void AChasingTwilightCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void AChasingTwilightCharacter::DoJumpEnd()
{
